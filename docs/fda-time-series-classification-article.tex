...
\caption{Diagram showing the raw data before (left) and result after (right) preprocessing.}
\end{figure}
\unskip
\vspace{5mm}
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{images/combined_preprocessed_data}
\caption{Chart containing three samples of recordings after preprocessing.}
\end{figure}
\unskip
\vspace{5mm}
...
\vspace{5mm}
\begin{figure}[H]
\includegraphics[width=\textwidth]{images/basis_interpolation}
\caption{The same three samples interpolated with basis spline functions.}
\end{figure}
\unskip
\vspace{5mm}
...
\caption{Binary classified validation subset.}
\end{figure}
\unskip
\vspace{5mm}
...
\caption{Multiclass classified validation subset.}
\end{figure}
\unskip
\vspace{5mm}
