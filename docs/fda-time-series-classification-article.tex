...
\newcommand{\orcidauthorA}{0000-0002-4313-1209} % Add 
\newcommand{\orcidauthorB}{0000-0003-3313-581X} % Add \orcidA{} behind the author's name
%\newcommand{\orcidauthorB}{0000-0000-0000-000X} % Add \orcidB{} behind the author's name

% Authors, for the paper (add full first names)
\Author{Jakub Poręba \orcidA{}, Jerzy Baranowski \orcidB{}}
...
\address{%
AGH University of Science \& Technology; jkbporeba@gmail.com, jb@agh.edu.pl}
...
\abstract{
Motor diagnostic is an important subject for consideration. Electric motors of different types are present in multitude of object from consumer goods, though everyday use devices to specialized equipment. Diagnostic of motors with acoustic signals is an interesting field, as microphones are present everywhere and are relatively easy sensor to process. In this paper we analyze acoustic signals for the purpose of motor diagnostics using functional data analysis. We represent spectrum (FFT) of the acoustic signals in a B-Spline basis and construct a classifier on that representation. Results are promising, especially for binary classifiers, while multiclass (softmax regression) show more sensitivity to dataset size.
}

% Keywords
\keyword{Functional Data Analysis; Motor Diagnostics; Acoustic Signal; Functional Logistic Regression}
...
\dataavailability{Source code and data are available in the repository: \url{https://github.com/KAIR-ISZ/fda-motor-acoustic}} 
